...
local FactionData = {
  ...
  ["faction_NorthAmerica"] = {
    ...
    start_cash = 20,
    start_technology = { "technology_ImprovedSpaceSuits", "technology_OrbitalRendezvous", "technology_IonEngines", "technology_CrewVehicles", "technology_ReusableLaunchVehicles", "technology_SpaceMissiles" },
    start_policy = { "policy_SpaceEconomics" },
    research = {
      biology = {
